...
function Experience() {
  ...
  <div className="experience-item">
    ...
    <div className="experience-content">
      ...
      <p>
        ...
        optimized website performance, managed deployments,
        maintenance, hosting, and supported digital marketing initiatives.
      </p>
    </div>
  </div>
  ...
  <div className="experience-item">
    ...
    <div className="experience-content">
      ...
      <p>
        ...
        coordinated operational workflows, inventory management,
        and technical support for healthcare research.
      </p>
    </div>
  </div>
  ...
  <div className="experience-item">
    ...
    <div className="experience-content">
      ...
      <p>
        Built end-to-end websites from planning to deployment,
        converted design mockups into responsive websites,
        and handled testing and production deployment.
      </p>
    </div>
  </div>
